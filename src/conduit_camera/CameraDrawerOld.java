...
import vision_drawing.DrawnObjectHandler;
 ...
 * @see BasicCamera
 */
public class CameraDrawerOld extends DrawnObjectHandler
{
	// ATTRIBUTES	----------------------------------------------------
	 ...
	 */
	public CameraDrawerOld(boolean autodeath, int depthLayers, BasicCamera camera)
	{
